        ...
        <body onClick={() => console.log('t')}>
          <main>
            <h1 style={{ fontWeight: 800 }}>
              <span style={{ color: '#007eff' }}>Vlas</span>
            </h1>
          ...
          <script
            dangerouslySetInnerHTML={{
              ...
              document.querySelector('form').addEventListener('submit', async e => {
                ...
                let create = await fetch('./api/shorten', {
                  method: 'POST',
                ...
                document.querySelector('form').innerHTML = '<input type="url" value="https://vlas.cf/' + url + '"readonly><input type="submit" value="복사">'
